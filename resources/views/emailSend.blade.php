    ...
    <div class="section-title">
        <div class="header w-96">
            <h1 class="uppercase font-bold text-2xl">get in touch</h1>
        </div>
    </div>
    

    <div class="sm:flex sm:justify-center mt-8">
        ...
        <div class="justify-items-center">
            ...
            <form action="{{url('sendemail/send')}}" method="POST" class=" form-group ">
                ...
                <input type="submit" name="send" value="Send" class="btn-lg bg-red-500 hover:bg-gray-900 hover:text-white">
            </form>
            {{-- end form  --}}
        </div>
        {{-- end form div  --}}
        ...
        <div class="pl-12 ">
            <div>
                ...
                <a href="#" class=" text-white ">webiciansKe@gmail.com</a>
            </div>
            <div class="mt-10"> 
                ...
                <a href="#" class=" text-white ">+254 795 223 915</a>
            </div>
            <div class="mt-10">
